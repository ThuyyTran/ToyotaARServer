...
if __name__ == '__main__':
    ...
    # imgs_list = []
    # imgs.append(img)
    # fea = model.extract_db_array_feat_batch(imgs )
    # imgs_list.append('output.png')
    # fea2 = model.extract_feat_batch(imgs_list )
    # Y = distance.cdist(fea, fea2, 'euclidean')
    # print("size feature " , fea[0] , fea2[0] ,  Y )
